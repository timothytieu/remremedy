      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <main className="mx-auto max-w-3xl py-12">
          ...
          <div className="prose prose-slate mx-auto dark:prose-invert lg:prose-lg">
            <p className="lead text-lg text-slate-700 dark:text-slate-300">
            ...
            <p>
              We're at a critical juncture where sleep science, AI capabilities, and societal awareness have converged.
              With the support of our community, we're building a solution that can scale to millions, creating a world
              where quality sleep is accessible to everyone.
            </p>
          </div>
        </main>
